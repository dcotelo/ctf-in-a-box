...
| File | Job |
|---|---|
| `fly.toml` | The app: which container serves the public, the two volumes, the machine size |
...
| `test/fly.bats` | 34 assertions, run by CI's `shell` job. Nothing is ever deployed |
