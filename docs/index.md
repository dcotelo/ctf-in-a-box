...
The module's content is a set of vulnerable targets. Every event provisions
all six; pick any subset for contestants to actually see from `/admin` →
Secure Development → Targets — nine challenges for a two-hour club session,
all 321 for a semester.
