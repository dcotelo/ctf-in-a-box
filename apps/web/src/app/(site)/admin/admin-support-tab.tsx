...
const BTN =
  "flex-none rounded-md bg-[#2563eb] px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-[#2563eb]/90 disabled:opacity-50";
const DANGER =
  "flex-none rounded-md border border-[#e53e3e]/50 px-3 py-1.5 text-xs text-[#e53e3e] transition-colors hover:bg-[#e53e3e]/10 disabled:opacity-50";
