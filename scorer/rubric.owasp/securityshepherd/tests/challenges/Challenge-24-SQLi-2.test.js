...
test("Challenge-24-SQLi-2", async () => {
  const body = await ssPost('/challenges/ffd39cb26727f34cbf9fce3e82b9d703404e99cdef54d2aa745f497abe070b', cookies, {"userIdentity": "\"' OR 1=1 -- \"@x.com"});
